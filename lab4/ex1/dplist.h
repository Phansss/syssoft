...
/* /** Prints the element inside a node of the DPlist
 * Callback function that defines how an elemnt_t should be printed to stdout.
*/
void dpl_print(dplist_t *list);


typedef void (*print_elem)(element_t);
